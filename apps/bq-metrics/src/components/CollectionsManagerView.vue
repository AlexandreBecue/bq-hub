...
const formDefaultSortByField = ref('');
const formDefaultSortOrder = ref<'asc' | 'desc'>('desc');
...
const startCreate = () => {
  ...
  formDefaultSortByField.value = '';
  formDefaultSortOrder.value = 'desc';
...
const startEdit = (col: CollectionSchema) => {
  ...
  formDefaultSortByField.value = col.defaultSortByField || '';
  formDefaultSortOrder.value = col.defaultSortOrder || 'desc';
  isEditing.value = true;
};
...
const handleSave = async () => {
  ...
  const schema: CollectionSchema = {
    ...
    defaultSortByField: formDefaultSortByField.value,
    defaultSortOrder: formDefaultSortOrder.value,
      ...
      <div class="form-grid">
        ...
        <div class="card glass metadata-card">
          ...
          <div class="form-group mt-3">
            <label for="colDefaultSortBy">Trier par défaut par</label>
            <p class="field-tip">Le champ utilisé pour trier les lignes à l'ouverture de l'explorateur.</p>
            <select id="colDefaultSortBy" v-model="formDefaultSortByField" class="form-control">
          ...
          <div class="form-group mt-3" v-if="formDefaultSortByField !== undefined">
            <label for="colDefaultSortOrder">Ordre de tri par défaut</label>
            <select id="colDefaultSortOrder" v-model="formDefaultSortOrder" class="form-control">
              <option value="asc">Ascendant (A-Z, 0-9, Plus ancien)</option>
              <option value="desc">Descendant (Z-A, 9-0, Plus récent)</option>
            </select>
          </div>
        </div>

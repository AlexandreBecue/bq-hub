...
L'application utilise une base IndexedDB locale hors-ligne (`BQClothDatabase`) et réutilise les identifiants de collections de `bq-metrics` pour une compatibilité totale :

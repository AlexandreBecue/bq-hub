...
**bq-learn** est ton application personnelle de révision de notions clés (principalement la culture générale) utilisant un moteur algorithmique de répétition espacée (Spaced Repetition) pour maximiser ta mémorisation à long terme sans effort superflu.

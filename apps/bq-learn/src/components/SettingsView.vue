...
const handleExport = async () => {
  try {
    ...
    a.href = url;
    a.download = `bq-learn-backup-${new Date().toISOString().split('T')[0]}.json`;
...
<template>
  <div class="settings-view">
    <div class="view-header">
      ...
      <p class="text-secondary">Gère tes synchronisations de cartes mémo avec Google Drive et configure tes sauvegardes.</p>
    </div>
    ...
    <div class="settings-grid">
        ...
        <div class="card glass mb-4">
          ...
          <div class="sync-actions-box mt-4">
            <div v-if="!isDriveConnected" class="drive-inactive-box text-center py-2">
              <p class="text-secondary text-sm mb-3">Connecte ton compte Google Drive pour synchroniser ta progression de mémorisation.</p>
      ...
      <div class="right-col-settings">
        ...
        <div class="card glass danger-card">
          ...
          <p class="text-secondary text-xs mb-4">Réinitialise l'application et vide toutes tes fiches locales de quiz.</p>
